...
<body>
<div class="jumbotron" style="margin-bottom: 0px"><h1>Prime Store</h1><p>Purchase the world!</p></div>
<nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top" id="navbar">
    <button class="navbar-toggler mr-auto" data-toggle="collapse" data-target="#collapse_target">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown_target">
                    ...
                    while ($row = $result_set->fetch_array()) {
                        $c_name = $row['name'];
                        echo "<a class='nav-link bg-dark' style='color: lightgray;' href='#'>$c_name</a>";
                    }
                    ?>
                </div>
            </li>
            <li class="nav-item dropdown"><a href="#" class="nav-link">Contact</a></li>
            <li class="nav-item dropdown"><a href="#" class="nav-link">About Us</a></li>
            <li class="nav-item dropdown"><a href="../Ecommerce/logout.php" class="nav-link">Log out</a></li>
        </ul>
    </div>
</nav>
</body>
